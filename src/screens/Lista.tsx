...
export const Lista = ({ items, setItems, savedLists, setSavedLists }: { items: any[], setItems: any, savedLists: any[], setSavedLists: any }) => {
  ...
  return (
    <div className="pt-4 pb-40 space-y-6 px-6">
      ...
      {/* Premium Status Summary Card */}
      <div className="bg-gradient-to-br from-emerald-50/70 to-teal-50/20 border border-emerald-100/50 p-4 rounded-[24px] shadow-sm">
        <div className="flex justify-between items-center">
          ...
          <span className="text-sm font-black text-emerald-700 bg-emerald-100/60 px-3.5 py-1 rounded-2xl">
            {Math.round(progress)}%
          </span>
        </div>
      </div>
